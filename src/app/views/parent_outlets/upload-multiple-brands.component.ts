    ...
    for (let index = 1; index < lines.length; index++) {
      if (lines[index] != '') {
        ...
        else if((row[1] != 0 && row[1] != 1  && row[1] != 2 ))
        {
          ...
          let cm = dialogRef.componentInstance;
          cm.heading = 'Upload unsuccessful';
          cm.message = 'Please complete the Delivery Status with entries “1” if enabled or “0” if disabled or “2” if both.';
          cm.cancelButtonText = 'Ok';
          cm.type = 'error';
          this.arrCsv = []
          this.clearInput.nativeElement.value = ''
        ...
        else if((row[2] != 0 && row[2] != 1))
        {
          ...
          let cm = dialogRef.componentInstance;
          cm.heading = 'Upload unsuccessful';
          cm.message = 'Please complete the New Brand Status with entries “1” if enabled or “0” if disabled.';
          cm.cancelButtonText = 'Ok';
          cm.type = 'error';
          this.arrCsv = []
          this.clearInput.nativeElement.value = ''
