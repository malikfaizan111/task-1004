...
import { imagePreviewComponent } from '../outlets/image-preview.component';
@Component({
    selector:'parent-outlet-image-change',
    templateUrl:'./change-parentoutlet-image.component.html',
    styleUrls:['./change-parentoutlet-image.component.scss'],
    encapsulation: ViewEncapsulation.None,
})
export class changeParentOutletImageComponent{
