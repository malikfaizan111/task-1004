...
export class NgxEditorToolbarComponent implements OnInit {
   ...
   */
  @Input() config: any;
  @ViewChild('urlPopover') urlPopover : any ;
  @ViewChild('imagePopover') imagePopover : any;
  @ViewChild('videoPopover') videoPopover : any;
  @ViewChild('fontSizePopover') fontSizePopover : any;
  @ViewChild('colorPopover') colorPopover : any;
  /**
  ...
  onFileChange(e : any): void {
    ...
    if (e.target.files.length > 0) {
      ...
      try {
        this._commandExecutorService.uploadImage(file, this.config.imageEndPoint).subscribe((event : any) => {
