...
@Component({
    selector: 'outlets-change-image',
    templateUrl: './outlets-change-image.component.html',
    styleUrls: ['./outlets-change-image.component.scss'],
    encapsulation: ViewEncapsulation.None,
  })
  export class ChangeOutletImage implements OnInit {
    ...
    constructor(protected router: Router, protected formbuilder: FormBuilder, protected dialog: MatDialog,
      ...
      protected paginationService: PaginationService, protected dialogRef: MatDialogRef<ChangeOutletImage>, @Optional() @Inject(MAT_DIALOG_DATA) public data: any) {
      this.Outlets = data.pageValue;
      this.outletId = data.outlet;
    ...
    onSaveOrder() {
      ...
      var method = 'outletImagesArrangment'
