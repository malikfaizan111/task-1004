...
@Component({
	selector: 'app-promo_codes-list',
	templateUrl: './promo_code-list.component.html'
})
export class PromoCodesListComponent implements OnInit 
{
	...
	addNew() 
	{
		this.router.navigateByUrl('main/promo_codes/add');
	}
	...
	onEditPromoCodes(promoCode : any): void 
	{
		...
		this.router.navigateByUrl('main/promo_codes/'+ promoCode.id);
	}
